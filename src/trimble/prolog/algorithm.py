import logging
import trimble.prolog.predicate
from collections import deque
from trimble.prolog.stdlib import cut
from trimble.prolog.term import *
from trimble.prolog.util import *
...
def _unify_var(var, x, bindings):
  if bindings.has_key(var):
    return _unify(bindings[var], x)
  try:
    if bindings.has_key(x):
      return _unify(var, bindings[x])
  except TypeError:
    pass
