...
from trimble.prolog.term import UniqueVariableFactory, VariableFactory, Var
from trimble.prolog.term import Atom, Pred
from trimble.prolog.algorithm import fol_bc_ask
from trimble.probstat.counting import choose, permute
from trimble.prolog.predicate import Rule, MutableRule
from trimble.prolog.partialordering import find_ordering
from trimble.prolog.partialordering import create_partial_comparator
...
def find_gainful_and_determinate_literals(predicate, 
  ...
  for next_predicate in bk:
      for literal, new_variables in variablization(next_predicate, 
                                                   variables, 
                                                   variable_factory):
