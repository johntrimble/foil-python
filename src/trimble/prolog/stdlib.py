...
def __define_list_predicates():
  import operator
  from trimble.prolog.term import VariableFactory, Term
  from trimble.prolog.predicate import RuleBasedPredicate, ListPredicate
...
def __define_arithmetic_predicates():
  from trimble.prolog.predicate import IsPredicate
  global est
  est = IsPredicate()
  
def __define_type_predicates():
  from trimble.prolog.predicate import RuleBasedPredicate, create_python_boolean_predicate
...
def __define_algorithmetic_predicates():
  from trimble.prolog.term import VariableFactory
  from trimble.prolog.predicate import CutPredicate, FailPredicate, RuleBasedPredicate
